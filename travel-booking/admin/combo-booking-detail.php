...
if (!isset($_GET['id'])) {
    header("Location: combo-bookings.php");
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['status'])) {
    ...
    mysqli_query($conn, "UPDATE combo_bookings SET status = '$new_status' WHERE id = $booking_id");
    $success = "Cập nhật trạng thái thành công!";
}

// Lấy thông tin booking
$sql = "SELECT b.*, u.full_name, u.email, u.phone, c.name AS combo_name 
...
$page_title = "Chi tiết Đặt Combo #" . $booking['id'];
...
<div class="row">
            ...
            <div class="card-body">
                <table class="table table-borderless mb-0">
                    <tbody>
                        ...
                        <tr>
                            <th>Tổng tiền:</th>
                            <td class="text-danger fw-bold"><?= number_format($booking['total_price']) ?> ₫</td>
                        </tr>
                        <tr>
                            <th>Ngày đặt:</th>
    ...
    <div class="col-md-4">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="mb-3 text-center">
                    ...
                    if ($status == 'confirmed') {
                        echo '<span class="badge bg-success fs-6 w-100 p-2">Đã duyệt (Xác nhận)</span>';
                ...
                <form action="combo-booking-detail.php?id=<?= $booking_id ?>" method="POST">
                    <div class="mb-3">
                        <label for="status" class="form-label">Cập nhật trạng thái</label>
                        <select class="form-select" id="status" name="status">
                            <option value="pending" <?= ($status == 'pending') ? 'selected' : '' ?>>Chờ duyệt</option>
                            <option value="confirmed" <?= ($status == 'confirmed') ? 'selected' : '' ?>>Xác nhận (Đã duyệt)</option>
        ...
        <a href="combo-bookings.php" class="btn btn-secondary w-100">

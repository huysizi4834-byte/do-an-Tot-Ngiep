...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['status'])) {
    ...
    mysqli_query($conn, "UPDATE service_bookings SET status = '$new_status' WHERE id = $booking_id");
    $success = "Cập nhật trạng thái thành công!";
}

// Lấy thông tin booking
$sql = "SELECT b.*, u.full_name, u.email, u.phone, s.name AS service_name, s.price as unit_price 
...
if (!$booking) {
    die("Đơn đặt dịch vụ không tồn tại!");
}

$page_title = "Chi tiết Đặt Dịch Vụ #" . $booking['id'];
...
<div class="row">
                ...
                <table class="table table-borderless mb-0">
                    <tbody>
                        <tr>
                            ...
                            <td class="fw-bold"><?= htmlspecialchars($booking['service_name']) ?></td>
                        </tr>
                        <tr>
                            <th>Ngày sử dụng:</th>
                        ...
                        <tr>
                            <th>Đơn giá:</th>
                            <td><?= number_format($booking['unit_price']) ?> ₫</td>
                        </tr>
                        <tr>
                            <th>Số lượng:</th>
                        ...
                        <tr>
                            <th>Tổng tiền:</th>
                            <td class="text-danger fw-bold fs-5"><?= number_format($booking['total_price']) ?> ₫</td>
                        </tr>
                        <tr>
                            <th>Ngày đặt:</th>
    ...
    <div class="col-md-4">
        ...
        <a href="service-bookings.php" class="btn btn-secondary w-100">
